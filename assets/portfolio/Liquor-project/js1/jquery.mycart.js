  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<table class="table table-hover table-responsive col-md-12 col-sm-12" id="' + idCartTable + '"></table>' +
        ...
        '<input type="text" class="form-control" id="address" placeholder="" value="" required="required">'+
        '<br>'+
